...
# ==============================================================
cpdef void isotropic(double[:,:,:] in_arr, double[:,:,:] out, int niter=10, 
    ...
    # Arrays:
    cdef double[:,:,:] out1   = np.empty((nX,nY,nZ), dtype=np.float64)
    cdef double[:,:,:] dA_dt = np.empty((nX,nY,nZ), dtype=np.float64)
...
# ==============================================================
cpdef void anisotropic(double[:,:,:] in_arr, int niter,
    double dt, int bc_type, double[:,:,:] out):
    # ==========================================================
    # Variables:
    cdef int  i
    cdef ssize_t  x, nX=in_arr.shape[0]+2
